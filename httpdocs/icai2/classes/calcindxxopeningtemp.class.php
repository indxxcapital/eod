...
//	$priorityArray=max($_SESSION['priority']);
	...
	//	$this->pr($_SESSION,true);
		...
		// 
		$indxxs=$this->db->getResult("select tbl_indxx_temp.* from tbl_indxx_temp  where status='1' and usersignoff='1' and dbusersignoff='1' and submitted='1'   limit  $page,$limit ",true);	
