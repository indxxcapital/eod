...
class Mycalcindxxopening extends Application{
	...
	function index()
	{
		...
		$indxxs=$this->db->getResult("select tbl_indxx.* from tbl_indxx  where status='1'  and id='31' and usersignoff='1' and dbusersignoff='1' and submitted='1' limit  $page,$limit",true);
		
		$totalindxxs=$this->db->getResult("select tbl_indxx.id from tbl_indxx  where status='1'  and id='31' and usersignoff='1' and dbusersignoff='1'    and submitted='1'",true);
