<?php /* Smarty version 2.6.14, created on 2014-06-16 12:56:42
         compiled from csi/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'field', 'csi/add.tpl', 14, false),)), $this); ?>
 <!-- BEGIN Main Content -->
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Add New Complex Strategy Index </h3>
                            </div>
...
index.php?module=casecurities';">Back</button>
                                    </div>
