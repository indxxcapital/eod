<?php /* Smarty version 2.6.14, created on 2014-07-22 12:06:16
         compiled from lsc/index.tpl */ ?>
<!-- BEGIN Main Content -->
 <?php echo '
 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href=\'index.php?module=lsc&event=delete&id=\'+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=lsc&event=deleteindex",
    type: "POST",
    data : parameters,
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=lsc&event=addNew" ><i class="icon-plus"></i></a>
...
" /></td>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=lsc&event=view&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                    <a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=lsc&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-edit"></i></a>
                    
                   <!-- index.php?module=lsc&event=delete&id=<?php echo $this->_tpl_vars['point']['id']; ?>
-->
