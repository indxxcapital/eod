<?php /* Smarty version 2.6.14, created on 2014-06-05 13:30:37
         compiled from uniquecurrencies/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'uniquecurrencies/index.tpl', 82, false),)), $this); ?>
<!-- BEGIN Main Content -->
 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href=\'index.php?module=users&event=delete&id=\'+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=users&event=deleteindex",
    type: "POST",
    data : parameters,
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Total <?php echo count($this->_tpl_vars['currencydata']); ?>
 Unique Currencies</h3>
                            </div>
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <!--<a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=users&event=addNew"><i class="icon-plus"></i></a>
                                        <a class="btn btn-circle show-tooltip" title="Print" href="#"><i class="icon-print"></i></a>
                                         <a class="btn btn-circle show-tooltip" title="Delete selected" id="deleteSelected" href="#"><i class="icon-trash"></i></a>
                                        -->
                                        <a class="btn btn-circle show-tooltip" title="Export to Excel" href="index.php?module=uniquecurrencies&event=exportExcel"><i class="icon-table"></i></a>
...
<table class="table table-advance" id="table1">
    ...
    <tbody>
    	<?php $_from = $this->_tpl_vars['currencydata']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" /></td>
            <td><?php echo $this->_tpl_vars['point']; ?>
</td>
