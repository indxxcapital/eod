<?php /* Smarty version 2.6.14, created on 2014-07-22 14:26:56
         compiled from lsc/view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'lsc/view.tpl', 66, false),)), $this); ?>
<!-- BEGIN Main Content -->
...
?>
 ...
 <?php if ($this->_tpl_vars['indxxdata']['0']['status'] != 1): ?>
  <a href="index.php?module=lsc&event=approve&id=<?php echo $this->_tpl_vars['indxxdata']['0']['id']; ?>
"><button class="btn btn-primary">Approve</button></a>
                                   
 <?php endif; ?>
 
 
   <a href="index.php?module=lsc&event=delete&id=<?php echo $this->_tpl_vars['indxxdata']['0']['id']; ?>
"><button class="btn btn-inverse">Delete</button></a>
 
                                    <a href="index.php?module=lsc"><button class="btn btn-inverse">Back</button></a>
