<?php /* Smarty version 2.6.14, created on 2014-09-01 13:52:58
         compiled from myindextemp/index.tpl */ ?>
<!-- BEGIN Main Content -->
<?php echo '
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>My Upcomming Index</h3>
                            </div>
...
" /> </td>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View Corporate Actions" href="index.php?module=myindextemp&event=viewca&id=<?php echo $this->_tpl_vars['point']['id']; ?>
