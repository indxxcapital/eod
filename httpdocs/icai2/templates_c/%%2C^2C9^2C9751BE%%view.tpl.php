<?php /* Smarty version 2.6.14, created on 2014-06-18 12:33:38
         compiled from csi/view.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'csi/view.tpl', 66, false),)), $this); ?>
<!-- BEGIN Main Content -->
...
?>
 ...
 <?php if ($this->_tpl_vars['indxxdata']['0']['status'] != 1): ?>
  <a href="index.php?module=csi&event=approve&id=<?php echo $this->_tpl_vars['indxxdata']['0']['id']; ?>
"><button class="btn btn-primary">Approve</button></a>
                                   
 <?php endif; ?>
 
 
   <a href="index.php?module=csi&event=delete&id=<?php echo $this->_tpl_vars['indxxdata']['0']['id']; ?>
"><button class="btn btn-inverse">Delete</button></a>
 
                                    <a href="index.php?module=csi"><button class="btn btn-inverse">Back</button></a>
