...
function convert_headged_security_to_indxx_curr()
{
	...
	/* TODO: Don't we need to check for active and signed indexes here and look for currenfcy mismatches? ? */
...
function convert_headged_security_to_indxx_curr_upcomingindex()
{
	...
	webopen("http://localhost/eod/httpdocs/icai2/index.php?module=calcindxxclosing&log_file=" . basename(log_file));
	//saveProcess(2);
	//mysql_close();
}
?>