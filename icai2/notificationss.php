...
$query3 = 'Select *  from tbl_indxx_temp where dateStart between "' . date ( "Y-m-d" ) . '" and "' . $dayesagodate . '"';
...
$sub = 'Softlayer - ICAI Notification';
...
// calccapub
// Calcrebalance
echo '<script>document.location.href="index.php?module=calcdelisttemp";</script>';
/* echo '<script>document.location.href="http://10.24.52.130/icai2/index.php?module=calcrebalance";</script>'; */
