<?php /* Smarty version 2.6.14, created on 2015-01-29 05:36:38
         compiled from blocks/messages.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'blocks/messages.tpl', 6, false),)), $this); ?>

<li class="hidden-phone">
                       
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <i class="icon-exclamation-sign"></i>
                                <span class="badge badge-success"><?php echo count($this->_tpl_vars['admin_message']); ?>
</span>
                            </a>
                                ...
                                <li class="msg">
                                    <a href="index.php?module=caindex">
                                        <div>
                                            ...
                                            <span class="msg-time">
                                                <span><?php echo $this->_tpl_vars['admin_message']['0']['uindex']; ?>
</span>
                                            </span>
                                        </div>
                                    </a>
