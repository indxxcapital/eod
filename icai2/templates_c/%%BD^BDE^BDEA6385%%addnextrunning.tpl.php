<?php /* Smarty version 2.6.14, created on 2014-12-24 05:34:17
...
index.php?module=caindex&event=subindextemp&id=<?php echo $this->_tpl_vars['sessData']['NewIndxxId']; ?>
';"><i class="icon-ok"></i> Submit Index for Approval</button>
