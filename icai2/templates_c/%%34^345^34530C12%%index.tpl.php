<?php /* Smarty version 2.6.14, created on 2014-12-19 00:28:56
         compiled from commodityindxx/index.tpl */ ?>
<!-- BEGIN Main Content -->
 <?php echo '
 ...
 var temp=confirm("Are you sure you want to delete this record ")
  if(temp)
   {	
	...
	window.location.href=\'index.php?module=commodityindxx&event=delete&id=\'+id;
	}
	else{
	return false;
	}
...
$.ajax({
    url : "index.php?module=commodityindxx&event=deleteindex",
    type: "POST",
    data : parameters,
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Running Index</h3>
                            </div>
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                      <!--  <a class="btn btn-circle show-tooltip" title="Add new record" href="index.php?module=commodityindxx&event=addNew" ><i class="icon-plus"></i></a>-->
...
" /></td>
            ...
            <td>
                <div class="btn-group">
                    <a class="btn btn-small show-tooltip" title="View" href="index.php?module=commodityindxx&event=view&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-zoom-in"></i></a>
                    <!--<a class="btn btn-small show-tooltip" title="Edit" href="index.php?module=commodityindxx&event=edit&id=<?php echo $this->_tpl_vars['point']['id']; ?>
"><i class="icon-edit"></i></a>-->
                    
                   <!-- index.php?module=commodityindxx&event=delete&id=<?php echo $this->_tpl_vars['point']['id']; ?>
-->
