<?php /* Smarty version 2.6.14, created on 2014-12-31 02:46:54
         compiled from uniquesecurities/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'uniquesecurities/index.tpl', 82, false),)), $this); ?>
<!-- BEGIN Main Content -->
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i>Total <?php echo count($this->_tpl_vars['userdata']); ?>
 Unique Securities</h3>
                            </div>
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        ...
                                        -->
                                        <a class="btn btn-circle show-tooltip" title="Export to Excel" href="index.php?module=uniquesecurities&event=exportExcel"><i class="icon-table"></i></a>
