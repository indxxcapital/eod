<?php /* Smarty version 2.6.14, created on 2015-01-05 10:47:35
         compiled from replacerunning/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'field', 'replacerunning/add.tpl', 14, false),)), $this); ?>
 <!-- BEGIN Main Content -->
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Add New Index</h3>
                            </div>
