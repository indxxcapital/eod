<?php /* Smarty version 2.6.14, created on 2014-12-18 18:08:45
         compiled from assignindex/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'field', 'assignindex/index.tpl', 14, false),)), $this); ?>
 <!-- BEGIN Main Content -->
...
<div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i>Assign Index</h3>
                            </div>
...
index.php?module=assignindex';">Back</button>-->
                                    </div>
