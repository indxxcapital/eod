...
class Mycalcindxxclosing extends Application{
	...
	{		
		...
		//exit;
		$indxxs=$this->db->getResult("select tbl_indxx.* from tbl_indxx  where status='1' and id='92' and usersignoff='1' and dbusersignoff='1' and submitted='1'  limit $page,1",true);
		
		$totalindxxs=$this->db->getResult("select tbl_indxx.id from tbl_indxx  where status='1'  and id='92' and usersignoff='1' and dbusersignoff='1'  and submitted='1'",true);
