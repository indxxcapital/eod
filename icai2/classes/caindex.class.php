...
class Caindex extends Application{
...
$this->addJs('js/flaty.js');
	...
	$this->_bodyTemplate="caindex/index";
...
/*	$this->validData[]=array("feild_label" =>"Priority",
	...
	$this->getValidFeilds();
	 ...
	 protected function view(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/view";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	//	$this->pr($sequruityData,true);
	 ...
	 protected function viewupcoming(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/viewupcoming";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	//	$this->pr($sequruityData,true);
	 ...
	 protected function viewsecurity(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/viewsecurity";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
//$this->smarty->assign("uploadsecuritydata",$uploadsecuritydata);
	...
	protected function inserteddata(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/inserted";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	protected function edit(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/edit";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
	...
	protected function updateddata(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/updated";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$body.='Your Indxx '.$indxx['name'].'('.$indxx['code'].') has been deleted by admin , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=view&id='.$_GET['id'].'">Click here </a> to do more.<br>Thanks ';
	...
	function upload()
	{
		...
		//$this->adduploadFeilds();	
	 	...
	 	$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/upload";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
function	submitapprove()
{
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/approve";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n"."CC: indexing@indxx.com". "\r\n";
$body='Hi <br>';
$body.='Your Upcoming Indxx '.$indxx['name'].'('.$indxx['code'].') has been approved by admin , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=viewupcoming&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n"."CC: indexing@indxx.com". "\r\n";
$body='Hi <br>';
$body.='New Upcoming Indxx '.$indxx['name'].'('.$indxx['code'].') has been approved by admin , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=view&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
	 ...
	 protected function reject(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/reject";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$body.='Your Indxx '.$indxx['name'].'('.$indxx['code'].') has been rejected by admin , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=view&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
	 ...
	 protected function finalsignoff(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/finalsignoff";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n"."CC: indexing@indxx.com". "\r\n";
$body='Hi <br>';
$body.='Your upcoming indxx '.$indxx['name'].'('.$indxx['code'].') has been rejected by database user , <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=viewupcoming&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
...
$body.='Signoff has been done for indxx '.$indxx['name'].'('.$indxx['code'].') by '.$_SESSION['User']['name'].', <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=view&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
	...
	if(($indxx['indexvalue']=='' || $indxx['indexvalue']==0 )&& $indxx['recalc']!=1)
	{
		...
		$this->Redirect("index.php?module=caupcomingindex&event=editfornext&id=".$_GET['id'],"You are not authorized to perofrm this task!","error");
	}
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n"."CC: indexing@indxx.com". "\r\n";
$body='Hi <br>';
$body.='Signoff has been done for indxx '.$indxx['name'].'('.$indxx['code'].') by '.$_SESSION['User']['name'].', <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caupcomingindex&event=view&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
...
$body.='Request File Submission has been done for indxx '.$indxx['name'].'('.$indxx['code'].') by IT Team, <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=view&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
		...
		$this->Redirect("index.php?module=caupcomingindex","Record updated successfully!!!","success");	
		}
		else
		{
				$this->Redirect("index.php?module=caupcomingindex","You are not authorized to perofrm this task!","error");
...
$body.='You have new indxx for Approval, <br> Please  <a href="'.$this->siteconfig->base_url.'index.php?module=caindex&event=view&id='.$_GET['id'].'">Click here </a> to check it.<br>Thanks ';
	...
	function subindextemp()
	{
		...
		{
			//$this->pr($_SESSION);
		//	echo "update tbl_indxx_temp set submitted='1',status='1' where tbl_indxx_temp.id='".$_GET['id']."'";
		//	echo "update tbl_indxx_ticker_temp set status='1' where indxx_id='".$_GET['id']."'";
$query=$this->db->query("update tbl_indxx_temp set submitted='1',status='1' where tbl_indxx_temp.id='".$_GET['id']."'");
$query=$this->db->query("update tbl_indxx_ticker_temp set status='1' where indxx_id='".$_GET['id']."'");
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n"."CC: indexing@indxx.com". "\r\n";
$body='Hi <br>';
$body.='You have new upcoming indxx for aupload and Approval , <br> Please visit '.$this->siteconfig->base_url.'index.php?module=caindex&event=viewupcoming&id='.$_SESSION['NewIndxxId'].'  to check it.<br>Thanks ';
		...
		unset($_SESSION['liveindexid']);
		unset($_SESSION['tempindexid']);
		$this->Redirect("index.php?module=caupcomingindex","Record updated successfully!!!","success");	
		}
		else
		{
...
$headers .= 'From: Indexing <indexing@indxx.com>' . "\r\n"."CC: indexing@indxx.com". "\r\n";
$body='Hi <br>';
$body.='You have new upcoming indxx for aupload and Approval , <br> Please visit '.$this->siteconfig->base_url.'index.php?module=caindex&event=viewupcoming&id='.$_GET['id'].'  to check it.<br>Thanks ';
	...
	function calcshare()
	{
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/calcshare";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
...
$xls->generateXML('indxx-data-'.$viewdata[0]['code']."-".$this->_date);		
	...
	protected function subadjfactor(){
		...
		$this->_baseTemplate="inner-template";
			$this->_bodyTemplate="caindex/adjfactor";
			$this->_title=$this->siteconfig->site_title;
			$this->_meta_description=$this->siteconfig->default_meta_description;
			$this->_meta_keywords=$this->siteconfig->default_meta_keyword;
